...
EXEC USP_addChiTietHoaDon 2005 , 3

select * from CHITIETHOADON where MAHOADON=2005
...
delete CHITIETHOADON where MACHITIETHOADON=1021 

delete from CHITIETHOADON WHERE MACHITIETHOADON=1023
...
BEGIN
	...
	UPDATE PHONG SET phong.TINHTRANG = 1 FROM PHONG INNER JOIN CHITIETHOADON ON (PHONG.MAPHONG = CHITIETHOADON.MAPHONG) WHERE (CHITIETHOADON.MAHOADON=@mahd)
	DELETE FROM CHITIETHOADON WHERE MAHOADON=@mahd
END

SELECT * FROM HOADON

select MAHOADON from HOADON WHERE MAKHACHHANG=1 

DELETE  FROM CHITIETHOADON
DELETE  FROM HOADON

SELECT * FROM PHONG
select * from hoadon where TINHTRANGHOADON =1

UPDATE PHONG SET phong.TINHTRANG = 0 FROM PHONG INNER JOIN CHITIETHOADON ON (PHONG.MAPHONG = CHITIETHOADON.MAPHONG) WHERE (CHITIETHOADON.MAHOADON=2013)